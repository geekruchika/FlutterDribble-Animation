...
class HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    appbarHeight = new Tween<double>(begin: 250.0, end: 350.0).animate(
      new CurvedAnimation(
    ...
    scroll.addListener(() {
      ...
      if (scroll.offset < -10) {
        appbarHeight.addListener(() {
          // var i = appbarHeight.value;
          // print("app:{$i}");
          this.setState(() {});
        });
        topImageController.forward();
      } else if (scroll.offset < -150.0)
        topImageController.reset();
      else if (scroll.offset >= 0) topImageController.reset();
    });
              ...
              new ListView(
                ...
                children: <Widget>[
                  new ImageBackground(
                    ...
                    topImageController: topImageController,
